...
from model.utils.net_utils import save_net, load_net, vis_detections, vis_detections_PIL, vis_detections_filtered_objects_PIL_crop, vis_detections_filtered_objects, calculate_center # (1) here add a function to viz
...
def one_soluition_hand_obj_detection_detector(image, loaded_dict, absolute_path, fasterRCNN, pascal_classes, image_name):
...
###############################################################################
          if vis:
            # visualization
            vis_detections_filtered_objects_PIL_crop(im2show, obj_dets, hand_dets, absolute_path, image_name, thresh_hand, thresh_obj)
